...
export function AnimatedTetrahedron() {
  ...
  useEffect(() => {
    ...
    const render = () => {
      ...
      const scale = Math.min(rect.width, rect.height) * 0.68;
      ...
      points.forEach((point) => {
        const alpha = 0.16 + (point.z + 1.5) * 0.22;
        ctx.fillStyle = `rgba(108, 71, 255, ${Math.min(alpha, 0.84)})`;
